<template>
    <n-grid :x-gap="12" cols="1 m:6" responsive="screen" style="margin: 20px 0;">
        <n-gi span="1 m:4" offset="0 m:1">
            <n-card title="Terms and Conditions" size="huge">
                <small>Last updated: November 21, 2022</small>
                <n-divider />

                <p>Welcome to TrackMyMoney!</p>
                <p>
                    These terms and conditions outline the rules and regulations
                    for the use of ShopnoSoft's Website, located at
                    <a href="https://trackmymoney.xyz"
                        >https://trackmymoney.xyz</a
                    >
                </p>

                <p>
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use TrackMyMoney if you
                ...
                <p>
                    We employ the use of cookies. By accessing TrackMyMoney, you
                    agreed to use cookies in agreement with the ShopnoSoft's
                    Privacy Policy.
                </p>
                ...
                <p>
                    Unless otherwise stated, ShopnoSoft and/or its licensors own
                    the intellectual property rights for all material on
                    TrackMyMoney. All intellectual property rights are reserved.
                    You may access this from TrackMyMoney for your own personal
                ...
                <p>You must not:</p>
                <ul>
                    <li>Republish material from TrackMyMoney</li>
                    <li>
                        Sell, rent or sub-license material from TrackMyMoney
                    </li>
                    <li>
                        Reproduce, duplicate or copy material from TrackMyMoney
                    </li>
                    <li>Redistribute content from TrackMyMoney</li>
                </ul>
                ...
                <p>
                    ShopnoSoft reserves the right to monitor all Comments and to
                ...
                <p>
                    You hereby grant ShopnoSoft a non-exclusive license to use,
                ...
                <p>
                    ...
                    compensates the absence of ShopnoSoft; and (d) the link is
                ...
                <p>
                    ...
                    inform us by sending an e-mail to ShopnoSoft. Please include
                ...
                <p>
                    No use of ShopnoSoft's logo or other artwork will be allowed
