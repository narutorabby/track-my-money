    ...
    <n-grid :x-gap="12" cols="1 m:6" responsive="screen" style="margin: 20px 0;">
        <n-gi span="1 m:4" offset="0 m:1">
            <n-card title="Privacy Policy" size="huge">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            electronic device, named TrackMyMoney
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to TrackMyMoney,
                            accessible from
                            <a
                                href="https://www.trackmymoney.xyz"
                                rel="external nofollow noopener"
                                target="_blank"
                                >https://www.trackmymoney.xyz</a
                            >
                        </p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: info@trackmymoney.xyz</li>
                </ul>
            </n-card>
        </n-gi>
    </n-grid>
